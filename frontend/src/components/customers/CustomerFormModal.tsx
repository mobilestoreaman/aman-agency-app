    ...
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="flex max-h-[90vh] flex-col sm:max-w-lg">
        ...
        <ScrollArea className="flex-1 pr-1">
          <Form {...form}>
            <form id="customer-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 p-1">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="e.g. Rahul Sharma" disabled={isPending} autoFocus />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
